...
ssize_t send_message(int socket, Message* message_ptr) {
    ...
    message_ptr->chat_node.port = htons(message_ptr->chat_node.port);
printf("in send: %d %d %s\n", message_ptr->chat_node.ip, message_ptr->chat_node.port, message_ptr->chat_node.name);
